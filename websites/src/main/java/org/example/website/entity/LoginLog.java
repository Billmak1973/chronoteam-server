...
@Table(name = "login_log", indexes = {
        // 從 @Index(name = "idx_login_username", columnList = "cust_username")
        // 改成 @Index(name = "idx_login_user", columnList = "user_id")
...
public class LoginLog {
    ...
    // 從 @Column(name = "cust_username", length = 50, nullable = false) private String username;
