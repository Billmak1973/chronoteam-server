...
//    // 查詢用戶的瀏覽歷史，按時間倒序
//    List<ViewHistory> findByCustomer_UsernameOrderByViewedAtDesc(String username);
//
//    // 查找用戶是否已瀏覽過某個商品
//    ViewHistory findByCustomer_UsernameAndProduct_Id(String username, Integer productId);
//
//    // 刪除半年前的記錄 (供定時任務使用)
//    @Modifying
//    @Transactional
...
//    void deleteOlderThanForUser(@Param("username") String username, @Param("cutoffDate") LocalDateTime cutoffDate);
//
//    // 🟢 刪除用戶的所有瀏覽記錄
//    @Modifying
//    @Transactional
